    ...
    <div class="col-md-6 col-lg-5">
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            <div class="card-header bg-primary py-4 text-center">
                <i class="bi bi-box-arrow-in-down text-white display-4"></i>
                <h4 class="text-white fw-bold mt-2">Registrar Entrada</h4>
                <p class="text-white-50 small mb-0">Ingresar stock de consumibles</p>
            </div>
            <div class="card-body p-4 p-md-5">
                <form action="index.php?page=lotes&action=store" method="POST">
